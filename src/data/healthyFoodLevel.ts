...
export const healthyFoodLevel: LevelDefinition = {
  ...
  foods: {
    ...
    egg: { id: 'egg', label: 'Egg', icon: '🍳', category: 'everyday', voice: 'Egg!', textureKey: 'food-sunny-side-up-egg', textureSize: 80, starValue: 1 },
    ...
    dragonFruit: { id: 'dragonFruit', label: 'Dragon Fruit', icon: '🐉', category: 'everyday', voice: 'Dragon fruit!', textureKey: 'food-dragon-fruit', textureSize: 94, starValue: 1 },
    ...
    cheeseburger: { id: 'cheeseburger', label: 'Cheeseburger', icon: '🍔', category: 'treat', voice: 'Cheeseburger. Small bites.', textureKey: 'food-cheeseburger', textureSize: 86, starValue: 0 },
    cupNoodles: { id: 'cupNoodles', label: 'Cup Noodles', icon: '🍜', category: 'treat', voice: 'Cup noodles. Small bites.', textureKey: 'food-cup-noodles', textureSize: 90, starValue: 0 },
    ketchup: { id: 'ketchup', label: 'Ketchup', icon: '🍅🥫', category: 'treat', voice: 'Ketchup. Small bites.', textureKey: 'food-ketchup', textureSize: 92, starValue: 0 },
  },
  route: [],
};
